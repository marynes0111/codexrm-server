...
public class SyncTest {
    ...
    void convertToJson(){
        ...
        try {
            mapper.writeValue(new File("C:\\Users\\mary\\Desktop\\json0.txt"), libraryTime0);
        } catch (IOException e) {
            e.printStackTrace();
        }


        r1.setAddress("Bo/gota,Colombia");
        r2.setNumber("10");
        ...
        try {
            mapper.writeValue(new File("C:\\Users\\mary\\Desktop\\json1.txt"), libraryTime1);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
